...
Install_Pspell()
{
	...
	case "${version}" in 
		...
		;;
		'80')
		extFile='/www/server/php/80/lib/php/extensions/no-debug-non-zts-20200930/pspell.so'
		;;
		'81')
		extFile='/www/server/php/81/lib/php/extensions/no-debug-non-zts-20210902/pspell.so'
		;;
	esac
